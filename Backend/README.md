...
Дополнительные поля: `category_source`, `description`, `product_url`, `image_url`, `data_warnings` (массив предупреждений о качестве данных). Показывайте предупреждения пользователю рядом с характеристиками. Все обязательные ранее согласованные поля сохранены.
...
- Поиск по умолчанию ограничен первыми 5 страницами (100 товаров на проверенном API); это не полный каталог. Детальная нормализация охватывает проверенные свойства; новые свойства/варианты требуют дополнительной инспекции.
